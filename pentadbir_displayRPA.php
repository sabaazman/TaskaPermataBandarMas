...
if (!isset($_GET['id_pendidik'])) {
    echo "Invalid Educator ID.";
    exit();
}

$id_pendidik = $_GET['id_pendidik'];

// Fetch RPA data for this educator
$sql = "SELECT * FROM rpa WHERE id_pendidik = '$id_pendidik' ORDER BY tarikh DESC";
$result = $conn->query($sql);

$sql_pendidik = "SELECT nama_pendidik FROM pendidik WHERE id_pendidik = '$id_pendidik'";
$result_pendidik = $conn->query($sql_pendidik);
$pendidik = $result_pendidik->fetch_assoc();
?>
...
<body class="dashboard-container">
    <div class="container">
        ...
        <a href="pentadbir_dashboard.php"><span>Dashboard Pentadbir</span></a>
            ...
            <main>
        <h2 style="text-align: center;">Senarai RPA oleh <?php echo $pendidik['nama_pendidik']; ?></h2>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='pentadbir_showRPA.php?id=" . $row['id_RPA'] . "'>" . $row['tajuk'] . "</a></td>";
                        echo "<td style='text-align: center;'>"  . $row['tarikh'] . "</td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='3'>Tiada RPA yang dijumpai.</td></tr>";
                }
                ?>
            </tbody>
        </table>
