...
$sql = "SELECT p.id_pendidik, p.nama_pendidik
        FROM pendidik p
        WHERE p.pengesahan = 1
        GROUP BY p.id_pendidik";
...
<body class="dashboard-container">
    <div class="container">
        ...
        <main>
        <h2 style="text-align: center; margin: 20px 0;">Rancangan Pelaksanaan Aktiviti</h2>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td style='text-align: center;'><a href='pentadbir_displayRPA.php?id_pendidik=" . $row['id_pendidik'] . "'>" . $row['nama_pendidik'] . "</a></td>";
                    echo "</tr>";
                }
            } else {
